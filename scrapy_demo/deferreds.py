...
# ~*~ THE END ~*~
# 若执行时提示文件禁止访问, 执行 sudo chmod -R 777 你的文件夹名.
if __name__ == "__main__":
    ...
    if args.example is not None:
        ...
        # 重要: 申明 sys.executable 否则报 OSError: [Errno 8] Exec format error: '.../deferreds.py'
        print(sys.executable, sys.argv[0])
        [subprocess.call([sys.executable, sys.argv[0], str(i)]) for i in range(1, 6)]
